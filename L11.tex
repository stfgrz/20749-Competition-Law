...
\section{Excessive Prices (United Brands)}
    ...
    \subsubsection{Recap}
        ...
        The test to identify and sanction excessive prices is two-pronged and consists of two phases:\sn{\includegraphics[width=0.5\linewidth]{graphics/L11-1_recap1.png}}
...
\section{Horizontal foreclosure}
    ...
    \subsection{Predatory pricing}
        ...
        \subsubsection{Proxies for MC}
            ...
            \begin{itemize}
                \item \textbf{Total costs (TC)} are all costs sustained by the firm to produce one unit of output.\marginnote{\includegraphics[width=0.5\linewidth]{graphics/L11-2.png}}
